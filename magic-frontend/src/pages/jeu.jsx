    ...
    return <MainLayout title="Jeu">
        <div className="flex flex-col mx-auto md:h-screen bg-amber-500">
                <div className="w-full h-2/12">
                    <label className="text-2xl w-full h-full font-semibold rounded-md border-black border-4 text-gray-900 bg-transparent flex items-center justify-center text-center">
                        Ennemie
                    </label>
                </div>
